            ...
            <div class="hero-content">
                <div class="hero-text">
                    ...
                    <div class="hero-actions">
                        <a href="<?= $basePath ?>/signup.php" class="btn btn-primary">Get Started</a>
        ...
        <section class="how-it-works">
            ...
            <div class="steps-container">
                <div class="step">
                    ...
                    <p>Search through lost and found items posted by fellow students.</p>
                </div>
                <div class="step">
                    <div class="step-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" viewBox="0 0 16 16">
                            <path d="M4 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H4zm0 1h8a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1z"/>
                            <path d="M4.5 3.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5zm0 2a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5zm0 2a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5zm0 2a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5zm0 2a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5z"/>
                        </svg>
                    </div>
                    <h3>2. Report Your Item</h3>
                    <p>Post details about items you've lost or found with photos.</p>
                </div>
                <div class="step">
                    <div class="step-icon">
                    ...
                    <h3>3. Reunite!</h3>
                    <p>Connect with owners through secure messaging to return items.</p>
                </div>
            </div>
        </section>
